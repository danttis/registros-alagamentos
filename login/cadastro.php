...
$sql_select = $conexao->prepare("SELECT id FROM usuarios WHERE email='$logado'");
$sql_select->execute();
...
$nome_img_1 = null;
$nome_img_2 = null;
$local = '/home/vhosts/projeto-estagio.orgfree.com/php_arquivos/img_uploands/';
...
$cadastrar = $conexao->prepare("INSERT INTO dados_alagamentos (id, id_usuario, estado, cidade, rua, data, intensidade, classificacao, imagem_1, imagem_2) VALUES (NULL, '$id', '$estado', '$cidade', '$rua', current_timestamp(), '$intensidade', '$classificacao', '$nome_img_1', '$nome_img_2');");
$executa = $cadastrar->execute();

if($executa){
    echo "<script language= 'JavaScript'>location.href='./cadastrar.php'</script>";
}
?>